...
* Code
    * Motivation
        * A simple regression example (R script: [r1_simple_regression_housing.R](r1_simple_regression.R); R notebook: [![](colab-badge.svg)](https://colab.research.google.com/github/tdmdal/r-workshop-students/blob/master/docs/rn1_A_Simple_Regression_Housing.ipynb))
